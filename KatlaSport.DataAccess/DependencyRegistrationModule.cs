...
namespace KatlaSport.DataAccess
{
    ...
    public sealed class DependencyRegistrationModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<EmployeeInfo.EmployeeContext>().As<EmployeeInfo.IEmployeeContext>().InstancePerRequest();
            builder.RegisterType<Orders.OrderContext>().As<Orders.IOrderContext>().InstancePerRequest();
        }
    }
}
